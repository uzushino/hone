...
impl User {
    pub fn user_id(&self) -> Rc<HasValue<u32, Output=Column<u32>>> {
        Rc::new(Column::new("User.user_id"))
    }

    pub fn email(&self) -> Rc<HasValue<String, Output=Column<String>>> {
...
impl Library {
    pub fn library_id(&self) -> Rc<HasValue<u32, Output=Column<u32>>> {
        Rc::new(Column::new("Library.library_id"))
    }

    pub fn title(&self) -> Rc<HasValue<String, Output=Column<String>>> {
